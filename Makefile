...
am__minerd_SOURCES_DIST = elist.h miner.h compat.h cpu-miner.c util.c \
	sha2.c scrypt.c yescrypt.c sha2-x86.S scrypt-x86.S sha2-x64.S \
...
am_minerd_OBJECTS = minerd-cpu-miner.$(OBJEXT) minerd-util.$(OBJEXT) \
	...
	minerd-yescrypt.$(OBJEXT) $(am__objects_1) $(am__objects_2) \
	$(am__objects_3)
...
ACLOCAL = ${SHELL} /home/user/Downloads/bitzeny-cpuminer/missing aclocal-1.15
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/user/Downloads/bitzeny-cpuminer/missing autoconf
AUTOHEADER = ${SHELL} /home/user/Downloads/bitzeny-cpuminer/missing autoheader
AUTOMAKE = ${SHELL} /home/user/Downloads/bitzeny-cpuminer/missing automake-1.15
AWK = gawk
CC = gcc
CCAS = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/user/Downloads/bitzeny-cpuminer/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = cpuminer
PACKAGE_BUGREPORT = 
...
WS2_LIBS = 
_libcurl_config = 
abs_builddir = /home/user/Downloads/bitzeny-cpuminer
abs_srcdir = /home/user/Downloads/bitzeny-cpuminer
abs_top_builddir = /home/user/Downloads/bitzeny-cpuminer
abs_top_srcdir = /home/user/Downloads/bitzeny-cpuminer
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/user/Downloads/bitzeny-cpuminer/install-sh
...
minerd_SOURCES = elist.h miner.h compat.h cpu-miner.c util.c sha2.c \
	scrypt.c yescrypt.c $(am__append_1) $(am__append_2) \
	$(am__append_3)
...
include ./$(DEPDIR)/minerd-yescrypt.Po
...
minerd-yescrypt.o: yescrypt.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-yescrypt.o -MD -MP -MF $(DEPDIR)/minerd-yescrypt.Tpo -c -o minerd-yescrypt.o `test -f 'yescrypt.c' || echo '$(srcdir)/'`yescrypt.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/minerd-yescrypt.Tpo $(DEPDIR)/minerd-yescrypt.Po
#	$(AM_V_CC)source='yescrypt.c' object='minerd-yescrypt.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-yescrypt.o `test -f 'yescrypt.c' || echo '$(srcdir)/'`yescrypt.c

minerd-yescrypt.obj: yescrypt.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-yescrypt.obj -MD -MP -MF $(DEPDIR)/minerd-yescrypt.Tpo -c -o minerd-yescrypt.obj `if test -f 'yescrypt.c'; then $(CYGPATH_W) 'yescrypt.c'; else $(CYGPATH_W) '$(srcdir)/yescrypt.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/minerd-yescrypt.Tpo $(DEPDIR)/minerd-yescrypt.Po
#	$(AM_V_CC)source='yescrypt.c' object='minerd-yescrypt.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-yescrypt.obj `if test -f 'yescrypt.c'; then $(CYGPATH_W) 'yescrypt.c'; else $(CYGPATH_W) '$(srcdir)/yescrypt.c'; fi`
